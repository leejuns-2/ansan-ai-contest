window.__RISK_DATA__ = {
  "generatedAt": "2026-06-10T14:07:59.186Z",
  ...
  "sourceLineage": [
    {
      "id": "khoa_tide_forecast_timeseries",
      "name": "국립해양조사원 조석예보 시계열",
      "agency": "해양수산부 국립해양조사원",
      "url": "https://www.data.go.kr/data/15156022/openapi.do",
      "status": "public_api_verified_waiting_for_key",
      "expectedFields": [
        "예측일시",
        "조위",
        "위도",
      ...
      "use": "조위 시계열, 조위 상승 속도, 위험 시작 시각 계산",
      "risk": "후보지별 대표 조위관측소 매핑 필요"
    },
    {
      "id": "khoa_tide_high_low",
      "name": "국립해양조사원 조석예보 고·저조",
      "agency": "해양수산부 국립해양조사원",
      "url": "https://www.data.go.kr/data/15156018/openapi.do",
      "status": "public_api_verified_waiting_for_key",
      "expectedFields": [
        "고조시각",
        "저조시각",
      ...
      "use": "만조까지 남은 시간, 간조/만조 위험 구간 계산",
      "risk": "안산 연안과 예보지점 대표성 검증 필요"
    },
    {
    ...
    },
    {
      ...
      "use": "풍랑, 강풍, 호우, 태풍, 폭풍해일 등 공식 위험기상 반영",
      "risk": "안산 육상 특보구역과 인근 해역 특보구역 코드 매핑 필요"
    },
    {
      "id": "kcg_coastal_risk_zone_shp",
      "name": "해양경찰청 연안위험구역현황",
      "agency": "해양경찰청",
      "url": "https://www.data.go.kr/data/15110661/fileData.do",
      "status": "local_file_ingested",
      "expectedFields": [
        "SHP",
        "DBF",
        "SHX",
      ...
      "use": "연안위험구역 polygon 지도 레이어 및 공간위험 피처",
      "risk": "후보지를 단일 대표 좌표로 계산하므로 운영 전 후보 구역 polygon으로 재계산 필요"
    },
    {
      "id": "kcg_control_zone_shp",
      "name": "해양경찰청 연안 출입통제구역 현황",
      "agency": "해양경찰청",
      "url": "https://www.data.go.kr/data/15110667/fileData.do",
      "status": "local_file_ingested",
      "expectedFields": [
        "SHP",
        "DBF",
      ...
      "use": "공식 출입통제구역 여부 표시. 안산시 임의 통제와 구분",
      "risk": "구봉도 주변 해상이 안산 공식 출입통제구역으로 확인됨. 법정 권한 주체를 화면에서 명확히 구분해야 함"
    },
    {
      ...
      "risk": "안산 직접 표기 1건으로 부족해 경기 연안/평택해경 관할 proxy를 함께 사용함"
    },
    {
      "id": "coast_risk_grid",
  ...
  "models": {
    ...
    "localAccidentHistory": {
      ...
      "priors": [
        {
          "locationId": "A01",
          "locationName": "방아머리 후보 구역",
          "dominantAccidentTypes": [
            "고립",
            "익수"
          ],
          "localMatchedCount": 44,
          "proxyMatchedCount": 88,
          "priorScore": 50,
          "confidence": "medium",
        ...
        {
          "locationId": "A02",
          "locationName": "탄도항 후보 구역",
          "dominantAccidentTypes": [
            "추락",
            "익수"
          ],
          "localMatchedCount": 8,
          "proxyMatchedCount": 12,
          "priorScore": 45,
          "confidence": "medium",
          "limitation": "원본 연안사고 이력의 발생지역 해상도가 시군·광역 단위라 후보지별 정밀 학습이 아니라 지역/관할 proxy prior로 사용한다."
        },
        {
          "locationId": "A03",
          "locationName": "시화방조제 후보 구역",
          "dominantAccidentTypes": [
            "추락",
            "고립"
          ],
          "localMatchedCount": 52,
          "proxyMatchedCount": 100,
          "priorScore": 56,
          "confidence": "medium",
          "limitation": "원본 연안사고 이력의 발생지역 해상도가 시군·광역 단위라 후보지별 정밀 학습이 아니라 지역/관할 proxy prior로 사용한다."
        },
        ...
        {
          "locationId": "A07",
          "locationName": "풍도 후보 구역",
          "dominantAccidentTypes": [
            "추락",
            "표류"
          ],
          "localMatchedCount": 8,
          "proxyMatchedCount": 14,
          "priorScore": 45,
          "confidence": "medium",
          "limitation": "원본 연안사고 이력의 발생지역 해상도가 시군·광역 단위라 후보지별 정밀 학습이 아니라 지역/관할 proxy prior로 사용한다."
        }
    ...
    "officialSpatialExposure": {
      "generatedAt": "2026-06-10T14:07:59.133Z",
      ...
      "locations": [
        {
          ...
          "insideCoastalRiskZone": true,
          "insideOfficialControlZone": false,
          "nearestCoastalRiskZoneDistanceM": 0,
          "nearestControlZoneDistanceM": 1490,
          "coastalRiskZoneName": "방아머리해변",
          "coastalRiskZoneType": "사망사고 발생구역",
          "controlZoneName": "구봉도 주변 해상",
          "authorityOwner": "평택해양경찰서 제2021-01호",
          "spatialExposureScore": 82,
          "evidence": {
            "riskZoneFeatureId": 447,
            "controlZoneFeatureId": 2
          }
        },
        {
          "locationId": "A02",
          ...
          "insideCoastalRiskZone": false,
          "insideOfficialControlZone": false,
          "nearestCoastalRiskZoneDistanceM": 17,
          "nearestControlZoneDistanceM": 12380,
          "coastalRiskZoneName": "탄도 갯벌(탄도항)",
          "coastalRiskZoneType": "연안사고 위험구역",
          "controlZoneName": "구봉도 주변 해상",
          "authorityOwner": "평택해양경찰서 제2021-01호",
          "spatialExposureScore": 72,
          "evidence": {
            "riskZoneFeatureId": 189,
            "controlZoneFeatureId": 2
          }
        },
        {
          ...
          "insideCoastalRiskZone": false,
          "insideOfficialControlZone": false,
          "nearestCoastalRiskZoneDistanceM": 22,
          "nearestControlZoneDistanceM": 5648,
          "coastalRiskZoneName": "시화방조제 내측",
          "coastalRiskZoneType": "연안사고 위험구역",
          "controlZoneName": "구봉도 주변 해상",
          "authorityOwner": "평택해양경찰서 제2021-01호",
          "spatialExposureScore": 72,
          "evidence": {
            "riskZoneFeatureId": 442,
            "controlZoneFeatureId": 2
          }
        },
        {
          ...
          "insideCoastalRiskZone": true,
          "insideOfficialControlZone": true,
          "nearestCoastalRiskZoneDistanceM": 0,
          "nearestControlZoneDistanceM": 0,
          "coastalRiskZoneName": "구봉도 주변 해상",
          "coastalRiskZoneType": "연안사고 다발구역",
          "controlZoneName": "구봉도 주변 해상",
          "authorityOwner": "평택해양경찰서 제2021-01호",
          "spatialExposureScore": 97,
          "evidence": {
            "riskZoneFeatureId": 444,
            "controlZoneFeatureId": 2
          }
        },
        {
          ...
          "insideCoastalRiskZone": false,
          "insideOfficialControlZone": false,
          "nearestCoastalRiskZoneDistanceM": 245,
          "nearestControlZoneDistanceM": 2737,
          "coastalRiskZoneName": "시화방조제 내측",
          "coastalRiskZoneType": "연안사고 위험구역",
          "controlZoneName": "구봉도 주변 해상",
          "authorityOwner": "평택해양경찰서 제2021-01호",
        ...
        },
        {
          ...
          "insideCoastalRiskZone": false,
          "insideOfficialControlZone": false,
          "nearestCoastalRiskZoneDistanceM": 3342,
          "nearestControlZoneDistanceM": 8626,
          "coastalRiskZoneName": "탄도 갯벌(탄도항)",
          "coastalRiskZoneType": "연안사고 위험구역",
          "controlZoneName": "구봉도 주변 해상",
          "authorityOwner": "평택해양경찰서 제2021-01호",
          "spatialExposureScore": 35,
          "evidence": {
            "riskZoneFeatureId": 189,
            "controlZoneFeatureId": 2
          }
        },
        {
          ...
          "insideCoastalRiskZone": false,
          "insideOfficialControlZone": false,
          "nearestCoastalRiskZoneDistanceM": 331,
          "nearestControlZoneDistanceM": 23329,
          "coastalRiskZoneName": "풍도 선착장",
          "coastalRiskZoneType": "연안사고 위험구역",
          "controlZoneName": "구봉도 주변 해상",
          "authorityOwner": "평택해양경찰서 제2021-01호",
          "spatialExposureScore": 72,
          "evidence": {
            "riskZoneFeatureId": 437,
            "controlZoneFeatureId": 2
          }
        }
      ]
  ...
  "locations": [
    {
      ...
      "historyPrior": {
        "sourceModel": "kcg-local-accident-history-prior-v1",
        "accidentTypes": [
          "고립",
          "익수"
        ],
      ...
      "series": [
        {
          ...
          "dataQuality": {
            ...
            "history": "kcg_local_accident_history_proxy",
            "spatial": "kcg_official_spatial_layers",
